...
const Meetings = ({ user, db }) => {
    ...
    const [allReflectionsForMeeting, setAllReflectionsForMeeting] = React.useState({});
                ...
                Object.entries(allReflections).forEach(([uid, meetings]) => {
                    if (
                        ...
                        onValue(userRef, (userSnapshot) => {
                            ...
                            setAllReflectionsForMeeting(prev => ({ ...prev, ...meetingReflections }));
                        }, { onlyOnce: true });
                    }
                });
            }
    ...
    return (
        <div>
            ...
            {showModal && (
               <ReflectionModal allReflections={allReflectionsForMeeting} meetingId={meetingId} setShowModal={setShowModal} />
            )}
        </div>
    );
};
